package net.morthen.resource_backpacks.backpack;
...
import net.morthen.resource_backpacks.backpack.util.BackpackInventory;
...
import net.morthen.resource_backpacks.client.util.BackpackClientUtils;
import net.morthen.resource_backpacks.config.common.BackpackConfig;
...
public class BackpackItem extends BlockItem {
    ...
    public MenuProvider getMenuProvider(ItemStack stack) {
        ...
        return switch(backpackLevel) {
            case LEATHER -> new SimpleMenuProvider((i, inventory, player) -> BackpackMenu.leatherMenu(i, inventory, backpackInventory, false), this.getName(this.getDefaultInstance()));
            case COPPER -> new SimpleMenuProvider((i, inventory, player) -> BackpackMenu.copperMenu(i, inventory, backpackInventory, false), this.getName(this.getDefaultInstance()));
            case GOLD -> new SimpleMenuProvider((i, inventory, player) -> BackpackMenu.goldMenu(i, inventory, backpackInventory, false), this.getName(this.getDefaultInstance()));
            case IRON -> new SimpleMenuProvider((i, inventory, player) -> BackpackMenu.ironMenu(i, inventory, backpackInventory, false), this.getName(this.getDefaultInstance()));
            case DIAMOND -> new SimpleMenuProvider((i, inventory, player) -> BackpackMenu.diamondMenu(i, inventory, backpackInventory, false), this.getName(this.getDefaultInstance()));
            case NETHERITE -> new SimpleMenuProvider((i, inventory, player) -> BackpackMenu.netheriteMenu(i, inventory, backpackInventory, false), this.getName(this.getDefaultInstance()));
            case END -> new SimpleMenuProvider((i, inventory, player) -> BackpackMenu.endMenu(i, inventory, player.getEnderChestInventory(), false), this.getName(this.getDefaultInstance()));
        };
    }
