...
import net.morthen.resource_backpacks.client.screen.BackpackMenuScreen;
import net.morthen.resource_backpacks.config.client.ClientConfig;
import net.morthen.resource_backpacks.config.common.BackpackConfig;
import net.morthen.resource_backpacks.config.common.ChestLootConfig;
import net.morthen.resource_backpacks.config.common.EntityConfig;
import net.morthen.resource_backpacks.registries.*;
