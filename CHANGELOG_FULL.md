...
- change order of backpack progress, iron and gold switching places
- shulkerboxes can be placed in all types of backpacks
- changing recipes to balance backpacks against shulker boxes
...
- porting to 1.21.10
- porting to 1.21.9
- removing style option from Client Options
    - replaced with resourcepacks
    - you can create your own resourcepacks to fit your style,
      as long it fits the template. The Template will be availabe a bit later on github

### v1.2.3
- fix neoforge networking
...
- fixing game crash when previewing the currently opened backpack
...
- fixing issue where the Backpack gets wrongly
  restored after the player respawns
...
- use correct common tag convention
  - previously was incompatible with other mods when they add f.e. diamond like items
- make network more robust, was possible to trigger an exception in rare cases
