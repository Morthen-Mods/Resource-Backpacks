...
import net.morthen.resource_backpacks.network.BackpackNetworkRegistry;
...
public class ResourceBackpacks {
    ...
    public ResourceBackpacks(FMLJavaModLoadingContext context) {
        ...
        RegisterClientTooltipComponentFactoriesEvent.BUS.addListener(this::registerTooltip);
