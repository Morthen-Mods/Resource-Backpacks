...
public class BackpackNetwork {
    ...
    public static SimpleChannel initPayloads() {
        SimpleChannel channel = ChannelBuilder.named(BackpackConstants.of("backpack_network")).acceptedVersions(Channel.VersionTest.exact(1)).networkProtocolVersion(1).simpleChannel();
