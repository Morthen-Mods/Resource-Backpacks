...
public final class BackpackTagsProvider {
    ...
    public static final class ItemTags extends ItemTagsProvider {
        ...
        public ItemTags(PackOutput packOutput, CompletableFuture<HolderLookup.Provider> lookupProvider, CompletableFuture<TagLookup<Block>> blockTags) {
            super(packOutput, lookupProvider, blockTags, BackpackConstants.MOD_ID);
        }
